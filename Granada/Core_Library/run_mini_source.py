...
if __name__ == "__main__":
    ...
    ## Project definition ##
    project_path_file = "/test_surfquake/Granada/outputs/project/project.pkl"
    ...
    working_directory = 'test_surfquake/Granada/outputs/source'

    # inventory path must be placed inside config_file
    inventory_path = "/test_surfquake/Granada/inputsmetadata/inv_all.xml"
    path_to_configfiles = '/test_surfquake/Granada/inputs/configs/source_spec_narrow.conf'
    locations_directory = '/test_surfquake/Granada/outputs/nll/all_loc'
    output_directory = os.path.join(working_directory, "output")
    summary_path = '/test_surfquake/Granada/outputs/source/source_summary.txt'
