...
path_events_file = '/test_surfquake/Granada/outputs/nll/all_loc'
path_source_file = '/test_surfquake//Granada/outputssource/source_summary.txt'
path_mti_summary = "/test_surfquake//Granada/outputs/mti/summary_mti.txt"
output_path = "/test_surfquake//Granada/outputs/catalog"
