...
if __name__ == "__main__":
    ...
    path_to_project = "/test_surfquake/Granada/outputs/project/project.pkl"
    path_to_configfiles = '/test_surfquake/Granada/inputs/configs/mti_config_mini_test.ini'
    output_directory = '/test_surfquake/Granada/outputs/mti'
    #
    # # Load the Project
