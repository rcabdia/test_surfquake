...
if __name__ == "__main__":
    ...
    ## Project definition ##
    project_path_file = "/Volumes/LaCie/all_andorra/mini_test/outputs/project/project.pkl"
    ...
    working_directory = '/Volumes/LaCie/all_andorra/mini_test/outputs/source'
    ...
    path_to_configfiles = '/Volumes/LaCie/all_andorra/mini_test/inputs/configs/source_spec_narrow.conf'
    locations_directory = '/Volumes/LaCie/all_andorra/mini_test/outputs/nll/loc'
    output_directory = os.path.join(working_directory, "output")
    summary_path = '/Volumes/LaCie/all_andorra/mini_test/outputs/source/source_summary.txt'
