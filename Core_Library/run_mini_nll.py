...
if __name__ == "__main__":
    ...
    working_directory = '/Volumes/LaCie/all_andorra/test_surfquake/outputs/nll'
    inventory_path = "/Volumes/LaCie/all_andorra/test_surfquake/inputs/metadata/inv_all.xml"
    path_to_configfiles = '/Volumes/LaCie/all_andorra/test_surfquake/inputs/configs/nll_config.ini'
